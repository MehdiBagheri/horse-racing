        ...
        for ($j = 0; $j < 10; $j++) {
            for ($i = 0; $i < count($horses); $i++) {
                ...
                if ($horses[$i][1]['distance'] >= 1500) {
                    ...
                    /** store positions into array in order to calculate the position of each horse it will add an arbitrary number to
                     * to current distance and then reduce time for specific horse so that it is possible to sort them *
                     */
